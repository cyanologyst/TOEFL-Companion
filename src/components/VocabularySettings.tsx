  ...
  return (
    <form className="settings-workspace" onSubmit={saveSettings}>
      <header className="settings-workspace-header">
        <div className="settings-workspace-header-copy">
          <p className="settings-workspace-eyebrow">Vocabulary review</p>
          <h1 className="settings-workspace-title">Reminder settings</h1>
          <p className="settings-workspace-intro">
            Shape a calm review rhythm. Changes are saved on this device.
          </p>
        </div>
        <span
          className={`settings-workspace-change-state${
      ...
      <div className="settings-workspace-search">
        <MagnifyingGlassIcon
          className="settings-workspace-search-icon"
          size={19}
          weight="regular"
          aria-hidden
        />
        <label className="settings-workspace-sr-only" htmlFor={`${idPrefix}-search`}>
          Search settings
        </label>
        <input
          ref={searchInputRef}
      ...
      <div className="settings-workspace-section-list">
          ...
          >
            <header className="settings-workspace-section-header">
              ...
              <div className="settings-workspace-section-heading">
                <h2 className="settings-workspace-section-title" id={`${idPrefix}-schedule-title`}>
                  Schedule
                </h2>
            ...
            <div className="settings-workspace-grid">
              ...
              <div className="settings-workspace-field settings-workspace-field--wide">
                ...
                {notificationPermission === "unsupported" ? (
                  <p className="settings-workspace-helper">
                    System notifications are unavailable on this device. In-app reminders still work
                    while TOEFL Companion is open.
                  </p>
                ) : null}
              </div>
            ...
            <div className="settings-workspace-stack">
              <div className="settings-workspace-feature-row">
                ...
                <div className="settings-workspace-feature-body">
                  ...
                  <p className="settings-workspace-helper">
                    This shortcut works only inside TOEFL Companion and is ignored while you type in
                    a field.
                  </p>
                </div>
              </div>
              ...
              <ToggleField
                ...
                onChange={(checked) => updateSetting("compactNotificationsWhenFullscreen", checked)}
              />
            </div>
          </section>
        ) : null}
        ...
        {showsSection("review") ? (
          ...
          >
            <header className="settings-workspace-section-header">
              ...
              <div className="settings-workspace-section-heading">
                <h2 className="settings-workspace-section-title" id={`${idPrefix}-review-title`}>
                  Review sessions
                </h2>
                <p className="settings-workspace-section-description">
        ...
        {showsSection("speech") ? (
          ...
          >
            <header className="settings-workspace-section-header">
              ...
              <div className="settings-workspace-section-heading">
                <h2 className="settings-workspace-section-title" id={`${idPrefix}-speech-title`}>
                  Speech &amp; dictionary
                </h2>
                <p className="settings-workspace-section-description">
              ...
              <div className="settings-workspace-field">
                ...
                >
                  ...
                  {selectedVoiceIsUnavailable ? (
                    <option value={draft.voiceName ?? ""}>{draft.voiceName} (unavailable)</option>
                  ) : null}
                  {voices.map((voice) => (
            ...
            <div className="settings-workspace-data-actions">
              <article className="settings-workspace-data-card">
                ...
                <div className="settings-workspace-data-copy">
                  ...
                  <p className="settings-workspace-data-description">
                    Download speaking history, saved questions, vocabulary, progress, and settings
                    as one JSON file. Saved audio remains on this device.
                  </p>
                </div>
                <button
                  type="button"
              ...
              <article className="settings-workspace-data-card settings-workspace-data-card--danger">
                ...
                <div className="settings-workspace-data-copy">
                  ...
                  <p className="settings-workspace-data-description">
                    Restore reminder, review, audio, and application defaults without deleting words
                    or learning history.
                  </p>
                </div>
                <button
      ...
      <footer className="settings-workspace-save-bar">
      ...
      >
        <Dialog.Portal>
          ...
          >
            <Dialog.Title>Reset vocabulary preferences?</Dialog.Title>
            <Dialog.Description>
              Reminder, review, audio, and application preferences will return to their defaults.
              Your words, progress, recordings, and history will stay intact.
            </Dialog.Description>
            {dataActionError ? (
            ...
            <div className="history-dialog-actions">
              ...
              <button
                ...
                disabled={isRunningDataAction}
                onClick={() => void resetVocabularyData()}
              >
                <ArrowCounterClockwiseIcon size={17} aria-hidden />
                {isRunningDataAction ? "Resetting…" : "Reset preferences"}
              </button>
            </div>
          </Dialog.Content>
        </Dialog.Portal>
